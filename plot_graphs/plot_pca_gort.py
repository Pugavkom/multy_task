...
def main():
    pca_a_romo = np.load("pca/600_1_2/go_rt/pca_a_gort.npy")
    pca_v_romo = np.load("pca/600_1_2/go_rt/pca_v_gort.npy")
    colors_romo = np.load("pca/600_1_2/go_rt/colors_pca_gort.npy")
    sp_names = list(np.load("pca/600_1_2/go_rt/gort_sp_names.npy"))
    print(sp_names)
