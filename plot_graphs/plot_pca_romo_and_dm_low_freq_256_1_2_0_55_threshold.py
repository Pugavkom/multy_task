...
def main():
    pca_a_dm = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/pca_a_dm.npy")
    pca_v_dm = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/pca_v_dm.npy")
    colors_dm = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/colors_pca_dm.npy")
    dm_values = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/dm_values.npy")
    ...
    pca_a_romo = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/pca_a_romo.npy")
    pca_v_romo = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/pca_v_romo.npy")
    colors_romo = np.load(
        "pca/256_1_2_low_freq_low_filter_v_th_0_55/colors_pca_romo.npy"
    )
    sp_names = list(
        np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/romo_sp_names.npy")
    )
    print(sp_names)
    ...
    ax2.text(
        pca_a_romo[1300 + full_time * 4, 0],
        pca_a_romo[1300 + full_time * 4, 1],
        pca_a_romo[1300 + full_time * 4, 2],
        "Second stimulus",
        fontsize=11,
        va="center",
        ha="center",
