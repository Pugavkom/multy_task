...
def main():
    pca_a_romo = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/pca_a_go.npy")
    pca_v_romo = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/pca_v_go.npy")
    colors_romo = np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/colors_pca_go.npy")
    sp_names = list(
        np.load("pca/256_1_2_low_freq_low_filter_v_th_0_55/go_sp_names.npy")
    )
    print(sp_names)
