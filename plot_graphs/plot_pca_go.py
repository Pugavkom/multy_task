...
def main():
    pca_a_romo = np.load("pca/600_1_2/go/pca_a_go.npy")
    pca_v_romo = np.load("pca/600_1_2/go/pca_v_go.npy")
    colors_romo = np.load("pca/600_1_2/go/colors_pca_go.npy")
    sp_names = list(np.load("pca/600_1_2/go/go_sp_names.npy"))
    print(sp_names)
