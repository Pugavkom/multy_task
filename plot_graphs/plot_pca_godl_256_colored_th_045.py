...
def main():
    pca_a_romo = np.load("pca/256_1_2_low_freq_low_filter_2999/pca_a_godl.npy")
    pca_v_romo = np.load("pca/256_1_2_low_freq_low_filter_2999/pca_v_godl.npy")
    colors_romo = np.load("pca/256_1_2_low_freq_low_filter_2999/colors_pca_godl.npy")
    sp_names_l = list(np.load("pca/256_1_2_low_freq_low_filter_2999/godl_sp_names.npy"))
    sp_names = []
