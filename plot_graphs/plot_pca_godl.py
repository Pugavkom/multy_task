...
def main():
    pca_a_romo = np.load("pca/600_1_2/go_dl/pca_a_godl.npy")
    pca_v_romo = np.load("pca/600_1_2/go_dl/pca_v_godl.npy")
    colors_romo = np.load("pca/600_1_2/go_dl/colors_pca_godl.npy")
    sp_names = list(np.load("pca/600_1_2/go_dl/godl_sp_names.npy"))
    print(sp_names)
