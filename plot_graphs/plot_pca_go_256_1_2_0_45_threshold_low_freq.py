...
def main():
    pca_a_romo = np.load("pca/256_1_2_low_freq_low_filter/pca_a_go.npy")
    pca_v_romo = np.load("pca/256_1_2_low_freq_low_filter/pca_v_go.npy")
    colors_romo = np.load("pca/256_1_2_low_freq_low_filter/colors_pca_go.npy")
    sp_names = list(np.load("pca/256_1_2_low_freq_low_filter/go_sp_names.npy"))
    print(sp_names)
