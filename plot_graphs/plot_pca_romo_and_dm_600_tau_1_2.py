...
def main():
    pca_a_dm = np.load("pca/600_1_2/dm/pca_a_dm.npy")
    pca_v_dm = np.load("pca/600_1_2/dm/pca_v_dm.npy")
    colors_dm = np.load("pca/600_1_2/dm/colors_pca_dm.npy")
    dm_values = np.load("pca/600_1_2/dm/dm_values.npy")
    ...
    pca_a_romo = np.load("pca/600_1_2/romo/pca_a_romo.npy")
    pca_v_romo = np.load("pca/600_1_2/romo/pca_v_romo.npy")
    colors_romo = np.load("pca/600_1_2/romo/colors_pca_romo.npy")
    sp_names = list(np.load("pca/600_1_2/romo/romo_sp_names.npy"))
    print(sp_names)
