...
def main():
    ...
    for task in tasks[:]:
        ...
        for i in range(len(symbols)):
            a = np.load(os.path.join("data", f"Z_a_{symbols[i]}_{task}_600_1_2.npy"))
            v = np.load(os.path.join("data", f"Z_v_{symbols[i]}_{task}_600_1_2.npy"))
        ...
        plt.savefig(f"eps/600/DPCA_{task}_600_1_2.eps")
        # plt.show()
        # plt.close()
